var Generator = function () {
	var generator = {
		...
		generateHashes: function (download) {
			...
			var jsfunc = "_" + jshash;
			var fileContents = "// This is a secret easter egg file, generated by https://rorosaurus.github.io/hidden-konami-js/"  + "\r\n" +
								"// For security reasons, this is saved as a .txt, but you should change the extension to .js" + "\r\n" +
								"\r\n" +
								...
								"function " + jsfunc + "(){" + "\r\n" +
								"\talert(\"This is excuted when the code is entered!\");" + "\r\n" +
								"}" + "\r\n";
